  ...
  useEffect(() => {
    const fetch_product = async () => {
      ...
      try {
        ...
        set_error_text('Could not load product details. Please try again.')
      } finally {
